    ...
    return(
        ...
        ${isHover ? "-rotate-12 translate-x-20" : "rotate-4" }`}>
            ...
            <header className="flex justify-between">
                ...
                <img className="w-10" src={iconSun} alt="Sun icon" />
            </header>
            ...
            <p className="text-[13px] text-Neutral-400 font-DM-Sans">We're so glad you're coming. The shutters will be open, the lemonade cold, and the cat - Poivre - pretending not to notice you</p>
